            ...
            <div class="row pt-5">
                <div class="col-md-8 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <h1 class="display-4 fw-bold mb-5"><strong>ZDSPGC TRANSACTION QUEUING</strong><span style="font-weight: normal !important; color: rgb(9, 17, 24);">&nbsp;</span><br>&nbsp;<span class="underline">System</span>.</h1>
                        <p class="fs-5 text-muted mb-5">Zamboanga Del Sur Provincial Government College<br></p>
                    </div>
                </div>
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="text-center position-relative"><img class="img-fluid" src="assets/img/illustrations/meeting.svg" style="width: 600px;"></div>
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="row g-0">
                    <div class="col-md-6 d-flex flex-column justify-content-center">
                        <div class="text-white p-4 p-md-5">
                            <h2 class="fw-bold text-white mb-3">ZDSPGC Transaction Queuing System</h2>
                            <p class="mb-4">Zamboanga Del Sur Provincial Government College<br>&nbsp;zdspgc@gmail.com<br></p>
                            <div class="my-3"><a class="btn btn-warning me-2 mt-2" role="button" href="#">Dashboard</a><a class="btn btn-light mt-2" role="button" href="#">Sign In</a></div>
                        </div>
                    </div>
