...
<head>
    ...
    <title>Log in - ZDSPGC Queuing</title>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="./"><span>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul><a class="btn btn-primary shadow" role="button" href="./admin/login.php" style="margin: 5px;">Admin Sign In</a>
                <a class="btn btn-primary shadow" role="button" href="guardmode.php">Guard Mode</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    <h2 class="display-6 fw-bold mb-5"><span class="underline pb-1"><strong>Staff Login</strong><br></span></h2>
                    <form method="post" action="login.php">
                        <div class="mb-3"><input class="shadow form-control" type="text" placeholder="Office Name" name="username"></div>
                        <div class="mb-3"></div>
                        <div class="mb-5"><button class="btn btn-primary shadow" type="submit" name="staff_login">Log in</button></div>
                        <p class="text-muted"><a href="./admin/login.php">Want to log in as admin?</a></p>
                    </form>
                    <?php
