...
<head>
    ...
    <title>Account Settings - ZDSPGC Queuing</title>
    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="../"><span>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><a class="btn btn-primary shadow" role="button" href="./admin_home.php" style="margin: 5px;">Go back</a>
                <a class="btn btn-primary shadow" role="button" href="./logout.php" style="margin: 5px;">Sign out</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container py-5">
                ...
                <div class="container">
                    <div class="text-white bg-primary border rounded border-0 border-primary d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5">
                        <div class="pb-2 pb-lg-1">
                            <h2 class="fw-bold text-warning mb-2"></h2>
                        </div>
                        <div class="my-2"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="display-6 fw-bold mb-4">Create&nbsp;<span class="underline">Staff</span></h2>
                    <p class="text-muted">Here you can create staff member.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" method="post" action="./functions/add_staff.php">
                            <div class="row">
                                <div class="col"><input class="form-control" type="text" name="staff_username" id="staff_username" placeholder="Staff Name"></div>
                            </div>
                            <div class="mb-3"></div><select class="form-select" name="office_id"    >
                            <?php
                            ...
                            <div class="mb-3"></div>
                            <div class="mb-3"></div>
                            <div><button class="btn btn-primary shadow d-block w-100" type="submit" name="add_staff">Create</button></div>
                        </form>
                    </div>
                </div>
            </div>
