...
<head>
    ...
    <title>Create Office - ZDSPGC Queuing</title>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="display-6 fw-bold mb-4">Create&nbsp;<span class="underline">Office</span></h2>
                    <p class="text-muted">Here you can create new Office</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" method="post" action="./functions/add_office.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col"><input class="form-control" placeholder="Office Name" name="name" required></div>
                            </div>
                            <div><button class="btn btn-primary shadow d-block w-100" type="Submit" value="Save" name="save_office">Create</button></div>
                        </form>
                    </div>
                </div>
            </div>
