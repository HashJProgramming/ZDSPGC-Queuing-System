...
<head>
    ...
    <title>Generate Report - ZDSPGC Queuing</title>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="display-6 fw-bold mb-4">Generate&nbsp;<span class="underline">Reports</span>?</h2>
                    <p class="text-muted">Here you can export all the data and save it to thumb drive.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" method="post" action="./functions/reports.php">
                            <h2 class="text-center">From&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; To</h2>
                            <div class="row">
                                <div class="col"><input class="form-control" type="date" name="from_date"></div>
                                <div class="col"><input class="form-control" type="date" name="to_date"></div>
                            </div>
                            ...
                            <div><button class="btn btn-primary shadow d-block w-100" type="submit" value="Generate" id="generate">Generate</button></div>
                        </form>
                    </div>
                </div>
            </div>
