        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="../"><span>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul><a class="btn btn-primary shadow" role="button" href="../staff-login.php" style="margin: 5px;">
                Staff Sign In</a><a class="btn btn-primary shadow" role="button" href="../guardmode.php">Guard Mode</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <div class='mb-3'><input class='shadow form-control' type='text' name='username' placeholder='Username'></div>
                    <div class='mb-3'><input class='shadow form-control' type='password' name='password' placeholder='Password'></div>
                    <div class='mb-5'><button class='btn btn-primary shadow' type='submit' name='admin_login'>Log in</button></div>
                    <p class='text-muted'><a href='../staff-login.php'>Staff Member Login.</a></p>
                </form>
